...
class AccountMove(models.Model):
	...
	def copy(self, default=None):
		...
		default.update(
			...
			total_detraccion_contabilidad = self.total_detraccion_contabilidad or False,
			total_detraccion_contabilidad_manual = self.total_detraccion_contabilidad_manual or False,
			)
